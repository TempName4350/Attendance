    ...
    function () {
      ...
      _createClass(AttendanceComponent, [{
        ...
        value: function onClick() {
          ...
          while (true) {
            var input = prompt('Input PantherID');
